...
def create_ennemy()
  initial_ennemy_stats = {hit_point: Stats::HitPoint.new(50,50),
                           force: Stats::Force.new(15),
                           defense: Stats::Defense.new(2)}

  succ_level = Stats::Level.new(1)
  succ_status = Stats::Status.new(initial_ennemy_stats)
...
def create_hero()
  ...
  initial_zeyn_stats = {hit_point: Stats::HitPoint.new(100,100),
                         force: Stats::Force.new(10),
                         defense: Stats::Defense.new(1)}
  zeyn_status = Stats::Status.new(initial_zeyn_stats)
...
def welcome_message(hero, ennemy)
  puts "\n == Welcome in the Mythique Battle System == \n
  Character: #{hero} \n
  Opponent: #{ennemy} \n\n"
end
